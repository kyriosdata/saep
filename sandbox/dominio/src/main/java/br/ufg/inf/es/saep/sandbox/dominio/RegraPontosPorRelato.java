...
public class RegraPontosPorRelato extends Regra {
     ...
     */
    public RegraPontosPorRelato(String variavel, int tipo, String descricao, float valorMaximo, float valorMinimo, String expressao, String entao, String senao, String tipoRelato, float pontosPorItem, List<String> dependeDe) {
    ...
    public Valor avalie(List<Avaliavel> avaliaveis, Map<String, Valor> contexto) {
        ...
        return new Valor(ajustaLimites(total));
    }
}
