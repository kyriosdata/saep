...
public class OrdenacaoItensTest {
    ...
    public void umItemOrdenacaoTrivial() {
        Regra regra = new RegraExpressao("um", 1, "d", 0, 0, "10", null, null, null, 0, new ArrayList<>(0));
    ...
    public void umItemDependenteDeAtributoOrdenacaoTrivial() {
        ...
        atributosX.add("x");
        Regra regraX = new RegraExpressao("rx", 1, "x", 0, 0, "x", null, null, null, 0, atributosX);

        // Regra: "y" (simples propriedade)
        List<String> atributosY = new ArrayList<>(1);
        atributosY.add("y");
        Regra regraY = new RegraExpressao("ry", 1, "y", 0, 0, "y", null, null, null, 0, atributosY);
        ...
        atributosZ.add("rx");
        atributosZ.add("ry");
        Regra regraZ = new RegraExpressao("rz", 1, "z", 0, 0, "rx + ry", null, null, null, 0, atributosZ);
    ...
    public void duasRegrasOrdenacaoUnica() {
        ...
        // a = 10
        Regra ra = new RegraExpressao("a", 1, "a = 10", 10, 0, "10", null, null, null, 0, new ArrayList<>(0));

        // b = a + 1
        ArrayList<String> atributos = new ArrayList<>(0);
        atributos.add("a");
        Regra rb = new RegraExpressao("b", 1, "b = a + 1", 11, 0, "a + 1", null, null, null, 0, atributos);
    ...
    public void cadItemInseridoUmaUnicaVez() {
        ...
        Regra ra = new RegraExpressao("a", 1, "a=1", 0, 0, "1", null, null, null, 0, dd);

        List<String> dependentesB = new ArrayList<>();
        dependentesB.add("a");
        Regra rb = new RegraExpressao("b", 1, "b=a+1", 0, 0, "a+1", null, null, null, 0, dependentesB);

        List<String> dependentesC = new ArrayList<>();
        dependentesC.add("a");
        Regra rc = new RegraExpressao("c", 1, "c=a+2", 0, 0, "a+2", null, null, null, 0, dependentesC);
