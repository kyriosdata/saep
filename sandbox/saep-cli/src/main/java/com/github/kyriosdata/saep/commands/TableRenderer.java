...
public final class TableRenderer {
    ...
    /**
     * Renders a 2 columns wide table with the given headers and rows.
     * If headers are provided it should match with the
     * number of columns.
     *
    ...
    /**
     * Renders a 3 columns wide table with the given headers and rows.
     * If headers are provided it should match with the
     * number of columns.
     *
